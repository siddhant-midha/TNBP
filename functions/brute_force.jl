...
function ZCorrection4th(loopValue,dx,dy,g,messages,T,indmat,N)
    dZ = 0
...
# this assumes BP fixed point is normalized to 1
# loopValue(loop): a function that inputs a loop and outputs its loop value
function logZCorrection4th(loopValue, dx, dy, g, messages, T, indmat, N)
    dlogZ = 0
    for origin_y = 1:dy, origin_x = 1:dx
        loop_l = loop4th(origin_x, origin_y, dx, dy)
        for loop in loop_l
...
function logZCorrection7th(loopValue, dx, dy, g, messages, T, indmat, N)
    dlogZ = 0
    for origin_y = 1:dy, origin_x = 1:dx
        loop_l = loop7th(origin_x, origin_y, dx, dy)
        for loop in loop_l
...
function logZCorrection8th(loopValue, dx, dy, g, messages, T, indmat, N)
    dlogZ = 0
    for origin_y = 1:dy, origin_x = 1:dx
        loop_l = loop8th(origin_x, origin_y, dx, dy)
        for loop in loop_l
...
function logZCorrection9th(loopValue, dx, dy, g, messages, T, indmat, N)
    dlogZ = 0
    for origin_y = 1:dy, origin_x = 1:dx
        loop_l = loop9th(origin_x, origin_y, dx, dy)
        for loop in loop_l
...
function logZCorrection10th(loopValue, dx, dy, g, messages, T, indmat, N)
    dlogZ = 0
    for origin_y = 1:dy, origin_x = 1:dx
        loop_l = loop10th(origin_x, origin_y, dx, dy)
        for loop in loop_l
